...
namespace _Experimenation.K._Third_Parties.System.Mini_First_Person_Controller.Scripts.Components
{
    public class FirstPersonAudio : MonoBehaviour
    {
        ...
        AudioSource GetOrCreateAudioSource(string name)
        {
            ...
            AudioSource result = global::System.Array.Find(GetComponentsInChildren<AudioSource>(), a => a.name == name);
            if (result)
                return result;
